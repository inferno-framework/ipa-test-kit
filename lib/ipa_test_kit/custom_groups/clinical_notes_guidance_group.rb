...
module IpaTestKit
  class ClinicalNotesGuidanceGroup < Inferno::TestGroup
    id :ipa_010_clinical_notes_guidance
    title 'Clinical Notes Guidance'
    short_description 'Verify DiagnosticReport and DocumentReference resources support the IPA Clinical Notes Guidance.'
    description %(
      ...
      will be checked for consistency against the [IPA Clinical Notes
      Guidance](https://www.hl7.org/fhir/uv/ipa/clinical-notes-guidance.html)
      ...
      * Radiology (LP29684-5)
      ...
      reports, the IPA server shall expose these reports through both
    ...
    test do
      id :ipa_010_clinical_note_attachments
      ...
      description %(
        ...
        To simplify the requirement, IPA IG requires servers implement the
