...
module IpaTestKit
  class SmokingstatusGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Smoking Status Observation Profile.'
    description %(
# Background

The IPA Smoking Status Observation sequence verifies that the system under test is
able to provide correct responses for Observation queries. These queries
must contain resources conforming to the IPA Smoking Status Observation Profile as
...
the [IPA Smoking Status Observation Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-smokingstatus). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_smokingstatus_patient_code_search_test
    test from: :ipa_010_smokingstatus_patient_category_date_search_test
    test from: :ipa_010_smokingstatus_patient_category_status_search_test
    test from: :ipa_010_smokingstatus_patient_code_date_search_test
    test from: :ipa_010_smokingstatus_patient_category_search_test
    test from: :ipa_010_smokingstatus_read_test
    test from: :ipa_010_smokingstatus_provenance_revinclude_search_test
    test from: :ipa_010_smokingstatus_validation_test
    test from: :ipa_010_smokingstatus_must_support_test
    test from: :ipa_010_smokingstatus_reference_resolution_test
  end
end
