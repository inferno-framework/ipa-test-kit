...
fail if any attempted read fails.
    ...
    test from: :ipa_010_heartrate_patient_code_search_test
    test from: :ipa_010_heartrate_patient_category_date_search_test
    test from: :ipa_010_heartrate_patient_category_status_search_test
