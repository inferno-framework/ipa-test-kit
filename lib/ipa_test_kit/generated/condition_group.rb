...
module IpaTestKit
  class ConditionGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Condition Profile.'
    description %(
# Background
...
must contain resources conforming to the IPA Condition Profile as
...
the [IPA Condition Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-condition). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_condition_patient_search_test
    test from: :ipa_010_condition_patient_onset_date_search_test
    test from: :ipa_010_condition_patient_category_search_test
