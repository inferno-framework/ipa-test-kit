...
module IpaTestKit
  class PatientGroup < Inferno::TestGroup
    title 'Patient Tests'
    short_description 'Verify support for the server capabilities required by the IPA Patient Profile.'
    description %(
# Background
...
must contain resources conforming to the IPA Patient Profile as
...
the [IPA Patient Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-patient). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_patient__id_search_test
    test from: :ipa_010_patient_identifier_search_test
    test from: :ipa_010_patient_name_search_test
    test from: :ipa_010_patient_birthdate_family_search_test
    test from: :ipa_010_patient_family_gender_search_test
    test from: :ipa_010_patient_birthdate_name_search_test
    test from: :ipa_010_patient_gender_name_search_test
