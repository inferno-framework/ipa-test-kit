...
module IpaTestKit
  class MedicationRequestGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA MedicationRequest Profile.'
    description %(
# Background
...
the [IPA MedicationRequest Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-medicationrequest). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_medication_request_patient_intent_search_test
    test from: :ipa_010_medication_request_patient_intent_encounter_search_test
    ...
    test from: :ipa_010_medication_request_reference_resolution_test
  end
end
