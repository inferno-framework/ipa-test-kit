...
module IpaTestKit
  class DiagnosticReportNoteGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA DiagnosticReport Profile for Report and Note exchange.'
    description %(
# Background
...
the [IPA DiagnosticReport Profile for Report and Note exchange](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-diagnosticreport-note). Each element is checked against
...
fail if any attempted read fails.
    ...
    id :ipa_010_diagnostic_report_note
    run_as_group
    ...
    test from: :ipa_010_diagnostic_report_note_patient_category_search_test
    test from: :ipa_010_diagnostic_report_note_patient_search_test
    test from: :ipa_010_diagnostic_report_note_patient_category_date_search_test
    test from: :ipa_010_diagnostic_report_note_patient_status_search_test
    test from: :ipa_010_diagnostic_report_note_patient_code_date_search_test
    test from: :ipa_010_diagnostic_report_note_patient_code_search_test
    test from: :ipa_010_diagnostic_report_note_read_test
    test from: :ipa_010_diagnostic_report_note_provenance_revinclude_search_test
    test from: :ipa_010_diagnostic_report_note_validation_test
    test from: :ipa_010_diagnostic_report_note_must_support_test
    test from: :ipa_010_diagnostic_report_note_reference_resolution_test
  end
end
