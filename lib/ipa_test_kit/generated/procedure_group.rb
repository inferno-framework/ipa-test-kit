...
module IpaTestKit
  class ProcedureGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Procedure Profile.'
    description %(
# Background

The IPA Procedure sequence verifies that the system under test is
able to provide correct responses for Procedure queries. These queries
must contain resources conforming to the IPA Procedure Profile as
...
the [IPA Procedure Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-procedure). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_procedure_patient_search_test
    test from: :ipa_010_procedure_patient_date_search_test
    test from: :ipa_010_procedure_patient_status_search_test
    test from: :ipa_010_procedure_patient_code_date_search_test
    test from: :ipa_010_procedure_read_test
    test from: :ipa_010_procedure_provenance_revinclude_search_test
    test from: :ipa_010_procedure_validation_test
    test from: :ipa_010_procedure_must_support_test
    test from: :ipa_010_procedure_reference_resolution_test
  end
end
