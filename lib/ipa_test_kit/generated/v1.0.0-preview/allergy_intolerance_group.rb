...
The US Core IPA-AllergyIntolerance sequence verifies that the system under test is
...
the [IPA-AllergyIntolerance](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-allergyintolerance). Each element is checked against
