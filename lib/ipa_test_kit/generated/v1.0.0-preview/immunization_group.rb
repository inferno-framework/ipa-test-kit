...
The US Core IPA-Immunization sequence verifies that the system under test is
...
the [IPA-Immunization](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-immunization). Each element is checked against
