...
The US Core IPA-MedicationRequest sequence verifies that the system under test is
...
the [IPA-MedicationRequest](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-medicationrequest). Each element is checked against
