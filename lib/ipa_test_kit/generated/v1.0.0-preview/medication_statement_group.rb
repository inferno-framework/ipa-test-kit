...
The US Core IPA-MedicationStatement sequence verifies that the system under test is
...
the [IPA-MedicationStatement](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-medicationstatement). Each element is checked against
