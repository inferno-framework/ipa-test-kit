require_relative 'problem_list_item/problem_list_item_patient_search_test'
require_relative 'problem_list_item/problem_list_item_patient_clinical_status_search_test'
require_relative 'problem_list_item/problem_list_item_patient_category_search_test'
require_relative 'problem_list_item/problem_list_item_patient_category_clinical_status_search_test'
require_relative 'problem_list_item/problem_list_item_patient_code_search_test'
require_relative 'problem_list_item/problem_list_item_patient_onset_date_search_test'
require_relative 'problem_list_item/problem_list_item_read_test'
require_relative 'problem_list_item/problem_list_item_provenance_revinclude_search_test'
require_relative 'problem_list_item/problem_list_item_validation_test'
require_relative 'problem_list_item/problem_list_item_must_support_test'
...
The US Core Condition IPA-problem-list-item sequence verifies that the system under test is
...
the [IPA-problem-list-item](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-problem-list-item). Each element is checked against
