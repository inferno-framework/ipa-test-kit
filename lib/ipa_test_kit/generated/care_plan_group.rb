...
module IpaTestKit
  class CarePlanGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA CarePlan Profile.'
    description %(
# Background

The IPA CarePlan sequence verifies that the system under test is
able to provide correct responses for CarePlan queries. These queries
must contain resources conforming to the IPA CarePlan Profile as
...
the [IPA CarePlan Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-careplan). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_care_plan_patient_category_search_test
    test from: :ipa_010_care_plan_patient_category_status_date_search_test
    test from: :ipa_010_care_plan_patient_category_status_search_test
    test from: :ipa_010_care_plan_patient_category_date_search_test
    test from: :ipa_010_care_plan_read_test
    test from: :ipa_010_care_plan_provenance_revinclude_search_test
    test from: :ipa_010_care_plan_validation_test
    test from: :ipa_010_care_plan_must_support_test
    test from: :ipa_010_care_plan_reference_resolution_test
  end
end
