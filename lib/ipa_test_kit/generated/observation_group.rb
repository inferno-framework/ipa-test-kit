...
module IpaTestKit
  class ObservationGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Observation Profile.'
    description %(
# Background
...
must contain resources conforming to the IPA Observation Profile as
...
the [IPA Observation Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-observation). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_observation_patient_category_search_test
    test from: :ipa_010_observation_patient_category_date_search_test
    test from: :ipa_010_observation_patient_category_status_search_test
