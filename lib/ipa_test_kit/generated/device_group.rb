...
module IpaTestKit
  class DeviceGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Implantable Device Profile.'
    description %(
# Background
...
the [IPA Implantable Device Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-implantable-device). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_device_patient_search_test
    test from: :ipa_010_device_patient_type_search_test
    test from: :ipa_010_device_read_test
    test from: :ipa_010_device_provenance_revinclude_search_test
    test from: :ipa_010_device_validation_test
    test from: :ipa_010_device_must_support_test
    test from: :ipa_010_device_reference_resolution_test
  end
end
