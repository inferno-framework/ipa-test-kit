...
module IpaTestKit
  class DocumentReferenceGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA DocumentReference Profile.'
    description %(
# Background
...
must contain resources conforming to the IPA DocumentReference Profile as
...
the [IPA DocumentReference Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-documentreference). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_document_reference_patient_search_test
    test from: :ipa_010_document_reference__id_search_test
    test from: :ipa_010_document_reference_patient_type_period_search_test
    test from: :ipa_010_document_reference_patient_type_search_test
    test from: :ipa_010_document_reference_patient_category_date_search_test
    test from: :ipa_010_document_reference_patient_status_search_test
    test from: :ipa_010_document_reference_patient_category_search_test
    test from: :ipa_010_document_reference_read_test
#    test from: :ipa_010_document_reference_provenance_revinclude_search_test
    test from: :ipa_010_document_reference_validation_test
    test from: :ipa_010_document_reference_must_support_test
    test from: :ipa_010_document_reference_reference_resolution_test
  end
end
