...
module IpaTestKit
  class DiagnosticReportLabGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA DiagnosticReport Profile for Laboratory Results Reporting.'
    description %(
# Background

The IPA DiagnosticReport for Laboratory Results Reporting sequence verifies that the system under test is
able to provide correct responses for DiagnosticReport queries. These queries
must contain resources conforming to the IPA DiagnosticReport Profile for Laboratory Results Reporting as
...
the [IPA DiagnosticReport Profile for Laboratory Results Reporting](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-diagnosticreport-lab). Each element is checked against
...
fail if any attempted read fails.
    ...
    id :ipa_010_diagnostic_report_lab
    run_as_group
    ...
    test from: :ipa_010_diagnostic_report_lab_patient_category_search_test
    test from: :ipa_010_diagnostic_report_lab_patient_search_test
    test from: :ipa_010_diagnostic_report_lab_patient_category_date_search_test
    test from: :ipa_010_diagnostic_report_lab_patient_status_search_test
    test from: :ipa_010_diagnostic_report_lab_patient_code_date_search_test
    test from: :ipa_010_diagnostic_report_lab_patient_code_search_test
    test from: :ipa_010_diagnostic_report_lab_read_test
    test from: :ipa_010_diagnostic_report_lab_provenance_revinclude_search_test
    test from: :ipa_010_diagnostic_report_lab_validation_test
    test from: :ipa_010_diagnostic_report_lab_must_support_test
    test from: :ipa_010_diagnostic_report_lab_reference_resolution_test
  end
end
