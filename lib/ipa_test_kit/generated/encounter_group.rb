...
module IpaTestKit
  class EncounterGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Encounter Profile.'
    description %(
# Background

The IPA Encounter sequence verifies that the system under test is
able to provide correct responses for Encounter queries. These queries
must contain resources conforming to the IPA Encounter Profile as
...
the [IPA Encounter Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-encounter). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_encounter_read_test
    test from: :ipa_010_encounter_patient_search_test
    test from: :ipa_010_encounter__id_search_test
    test from: :ipa_010_encounter_identifier_search_test
    test from: :ipa_010_encounter_class_patient_search_test
    test from: :ipa_010_encounter_patient_status_search_test
    test from: :ipa_010_encounter_patient_type_search_test
    test from: :ipa_010_encounter_date_patient_search_test
    test from: :ipa_010_encounter_provenance_revinclude_search_test
    test from: :ipa_010_encounter_validation_test
    test from: :ipa_010_encounter_must_support_test
    test from: :ipa_010_encounter_reference_resolution_test
  end
end
