...
module IpaTestKit
  class ObservationLabGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Laboratory Result Observation Profile.'
    description %(
# Background

The IPA Laboratory Result Observation sequence verifies that the system under test is
able to provide correct responses for Observation queries. These queries
must contain resources conforming to the IPA Laboratory Result Observation Profile as
...
the [IPA Laboratory Result Observation Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-observation-lab). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_observation_lab_patient_category_search_test
    test from: :ipa_010_observation_lab_patient_category_date_search_test
    test from: :ipa_010_observation_lab_patient_category_status_search_test
    test from: :ipa_010_observation_lab_patient_code_date_search_test
    test from: :ipa_010_observation_lab_patient_code_search_test
    test from: :ipa_010_observation_lab_read_test
    test from: :ipa_010_observation_lab_provenance_revinclude_search_test
    test from: :ipa_010_observation_lab_validation_test
    test from: :ipa_010_observation_lab_must_support_test
    test from: :ipa_010_observation_lab_reference_resolution_test
  end
end
