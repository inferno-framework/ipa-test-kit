...
module IpaTestKit
  class PediatricBmiForAgeGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Pediatric BMI for Age Observation Profile.'
    description %(
# Background
...
the [IPA Pediatric BMI for Age Observation Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/pediatric-bmi-for-age). Each element is checked against
...
fail if any attempted read fails.
    ...
    id :ipa_010_pediatric_bmi_for_age
    run_as_group
    ...
    test from: :ipa_010_pediatric_bmi_for_age_patient_code_search_test
    test from: :ipa_010_pediatric_bmi_for_age_patient_category_date_search_test
    test from: :ipa_010_pediatric_bmi_for_age_patient_category_status_search_test
    test from: :ipa_010_pediatric_bmi_for_age_patient_code_date_search_test
    test from: :ipa_010_pediatric_bmi_for_age_patient_category_search_test
    test from: :ipa_010_pediatric_bmi_for_age_read_test
    test from: :ipa_010_pediatric_bmi_for_age_provenance_revinclude_search_test
    test from: :ipa_010_pediatric_bmi_for_age_validation_test
    test from: :ipa_010_pediatric_bmi_for_age_must_support_test
    test from: :ipa_010_pediatric_bmi_for_age_reference_resolution_test
  end
end
