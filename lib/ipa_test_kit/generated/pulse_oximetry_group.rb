...
module IpaTestKit
  class PulseOximetryGroup < Inferno::TestGroup
    ...
    short_description 'Verify support for the server capabilities required by the IPA Pulse Oximetry Profile.'
    description %(
# Background

The IPA Pulse Oximetry sequence verifies that the system under test is
able to provide correct responses for Observation queries. These queries
must contain resources conforming to the IPA Pulse Oximetry Profile as
...
the [IPA Pulse Oximetry Profile](http://hl7.org/fhir/uv/ipa/StructureDefinition/ipa-pulse-oximetry). Each element is checked against
...
fail if any attempted read fails.
    ...
    test from: :ipa_010_pulse_oximetry_patient_code_search_test
    test from: :ipa_010_pulse_oximetry_patient_category_date_search_test
    test from: :ipa_010_pulse_oximetry_patient_category_status_search_test
    test from: :ipa_010_pulse_oximetry_patient_code_date_search_test
    test from: :ipa_010_pulse_oximetry_patient_category_search_test
    test from: :ipa_010_pulse_oximetry_read_test
#    test from: :ipa_010_pulse_oximetry_provenance_revinclude_search_test
    test from: :ipa_010_pulse_oximetry_validation_test
    test from: :ipa_010_pulse_oximetry_must_support_test
    test from: :ipa_010_pulse_oximetry_reference_resolution_test
  end
end
